...
export default function EditUserForm({ user }) {
    ...
    // SUPER ADMIN: Tidak bisa edit dirinya sendiri (redirect atau disable semua)
    const isSuperAdminSelfEdit =
        isSelfEdit && currentUser.role === "super_admin";

    // Determine if role field should be disabled
    const isRoleDisabled = isEditingSuperAdmin || isSelfEdit;

    // Determine if password field should be shown (tapi dengan placeholder)
    const showPasswordField = !isEditingSuperAdmin;

    // Determine if delete button should be disabled
    const isDeleteDisabled = isEditingSuperAdmin || isSelfEdit;
    ...
    const onSubmit = form.handleSubmit((data) => {
        // Jika sedang edit super admin atau edit sendiri, hapus role dari data
    ...
    // Jika super admin mencoba edit dirinya sendiri, tampilkan pesan error
    ...
    return (
        <Form {...form}>
            <form onSubmit={onSubmit}>
                ...
                {/* Warning Banner for Super Admin Edit */}
                {isEditingSuperAdmin && (
                ...
                {isSelfEdit && !isEditingSuperAdmin && (
                ...
                <div className="grid gap-4 lg:grid-cols-6">
                    ...
                    <div className="space-y-4 lg:col-span-4">
                        ...
                        {/* Password - Hanya tampil untuk non super admin */}
                        {showPasswordField && (
                            <Card>
                                <CardHeader>
                        ...
                        {/* Password Info untuk Super Admin */}
                        {!showPasswordField && (
                            <Card>
                                <CardHeader>
                    ...
                    <div className="space-y-4 lg:col-span-2">
                        ...
                        {/* Info untuk akun yang tidak bisa dihapus */}
                        {isDeleteDisabled && (
