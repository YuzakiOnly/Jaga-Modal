...
export default function HistorySummary({
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="bg-emerald-600 rounded-2xl p-4 sm:p-5 shadow-sm flex flex-col h-full">
                ...
                <div className="mt-auto">
                    ...
                    {summary.total_platform_fee > 0 && (
                        <p className="text-xs text-emerald-200 mt-1 break-words">
                            Bersih {fmt(summary.total_net_revenue)} · Biaya
                            platform {fmt(summary.total_platform_fee)}
                        </p>
                    )}
                </div>
            </div>
            ...
            <div className="md:col-span-3 bg-white rounded-2xl p-4 shadow-sm border border-slate-200 flex flex-col h-full">
                ...
                <div className="mt-auto">
                    <div className="flex flex-wrap justify-center gap-2">
                        {paymentMethods.map((m) => (
                            <button
                                key={m.key}
                                onClick={() => onChannelFilter(m.filterValue)}
